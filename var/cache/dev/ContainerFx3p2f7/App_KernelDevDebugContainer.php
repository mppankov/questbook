...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\ConferenceCrudController' => 'getConferenceCrudControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/TwigEventSubscriber.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Jh5kQIoUKM', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.easyadmin'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vENyvbeZXC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('exotsAij+m', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9OL0QyP9v+', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8584fbz9LF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityListenerResolverService($container)
    {
        $container->services['doctrine.orm.default_entity_listener_resolver'] = $instance = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerEntityListenerResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\EntityListener\\ConferenceEntityListener' => ['privates', 'App\\EntityListener\\ConferenceEntityListener', 'getConferenceEntityListenerService', true],
        ], [
            'App\\EntityListener\\ConferenceEntityListener' => '?',
        ]));

        $instance->registerService('App\\EntityListener\\ConferenceEntityListener', 'App\\EntityListener\\ConferenceEntityListener');
        $instance->registerService('App\\EntityListener\\ConferenceEntityListener', 'App\\EntityListener\\ConferenceEntityListener');
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventSubscriber\\TwigEventSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\TwigEventSubscriber'] ?? self::getTwigEventSubscriberService($container)), 'onControllerEvent'], 0);
    ...
    protected static function getTwigEventSubscriberService($container)
    {
        ...
        return $container->privates['App\\EventSubscriber\\TwigEventSubscriber'] = new \App\EventSubscriber\TwigEventSubscriber($a, ($container->privates['App\\Repository\\ConferenceRepository'] ?? self::getConferenceRepositoryService($container)));
    }
     ...
     */
    protected static function getConferenceRepositoryService($container)
    {
        return $container->privates['App\\Repository\\ConferenceRepository'] = new \App\Repository\ConferenceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(function () use ($container) {
            ...
            yield 0 => ($container->services['App\\Controller\\Admin\\CommentCrudController'] ?? $container->load('getCommentCrudControllerService'));
            yield 1 => ($container->services['App\\Controller\\Admin\\ConferenceCrudController'] ?? $container->load('getConferenceCrudControllerService'));
        }, 2), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)));
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H4yPhmGO4k', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('--NoMza76T', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('GPMQrCiJN8', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+vt0PCwBjM', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OIOcqQ3M3u', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5B2SfUMSF4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\CommentCrudController', 'App\\Controller\\Admin\\ConferenceCrudController', 'App\\Controller\\Admin\\DashboardController', 'App\\Controller\\ConferenceController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'photo_dir' => (\dirname(__DIR__, 4).'/public/uploads/photos'),
